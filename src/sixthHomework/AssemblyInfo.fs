...
[<assembly: AssemblyTitleAttribute("sixthHomework")>]
[<assembly: AssemblyProductAttribute("sixthHomework")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "sixthHomework"
    let [<Literal>] AssemblyProduct = "sixthHomework"
