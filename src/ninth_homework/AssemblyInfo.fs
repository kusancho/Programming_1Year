...
[<assembly: AssemblyTitleAttribute("ninth_homework")>]
[<assembly: AssemblyProductAttribute("ninth_homework")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "ninth_homework"
    let [<Literal>] AssemblyProduct = "ninth_homework"
