...
[<assembly: AssemblyTitleAttribute("seventhHomework")>]
[<assembly: AssemblyProductAttribute("seventhHomework")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "seventhHomework"
    let [<Literal>] AssemblyProduct = "seventhHomework"
