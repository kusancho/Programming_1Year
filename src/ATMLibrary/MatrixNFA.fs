...
let epsClosureOLD (atm:MatrixNFA<_>) =
...
let acceptOLD (nfa:MatrixNFA<_>) (input: list<_>) =
    ...
    toDot nfa2 "/home/kusancho/progahw/homework/src/ATMLibrary/nfa2.dot"
    toDot (new MatrixNFA<_>(newStartState, new HashSet<_>(newFinalStates), intersection)) "/home/kusancho/progahw/homework/src/ATMLibrary/outIntersection.dot"
