...
[<assembly: AssemblyTitleAttribute("Comparison")>]
[<assembly: AssemblyProductAttribute("Comparison")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Comparison"
    let [<Literal>] AssemblyProduct = "Comparison"
