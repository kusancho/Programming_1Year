...
[<assembly: AssemblyTitleAttribute("seventhHomework.Tests")>]
[<assembly: AssemblyProductAttribute("seventhHomework.Tests")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "seventhHomework.Tests"
    let [<Literal>] AssemblyProduct = "seventhHomework.Tests"
