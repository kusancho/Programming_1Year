...
[<assembly: AssemblyTitleAttribute("eightHW.Tests")>]
[<assembly: AssemblyProductAttribute("eightHW")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "eightHW.Tests"
    let [<Literal>] AssemblyProduct = "eightHW"
