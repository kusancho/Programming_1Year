...
[<assembly: AssemblyTitleAttribute("MatrixGenerator.Tests")>]
[<assembly: AssemblyProductAttribute("MatrixGenerator")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MatrixGenerator.Tests"
    let [<Literal>] AssemblyProduct = "MatrixGenerator"
