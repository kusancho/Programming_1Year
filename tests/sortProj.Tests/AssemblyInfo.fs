...
[<assembly: AssemblyTitleAttribute("sortProj.Tests")>]
[<assembly: AssemblyProductAttribute("sortProj")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "sortProj.Tests"
    let [<Literal>] AssemblyProduct = "sortProj"
