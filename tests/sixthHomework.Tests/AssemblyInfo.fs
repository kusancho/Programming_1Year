...
[<assembly: AssemblyTitleAttribute("sixthHomework.Tests")>]
[<assembly: AssemblyProductAttribute("sixthHomework.Tests")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "sixthHomework.Tests"
    let [<Literal>] AssemblyProduct = "sixthHomework.Tests"
