...
[<assembly: AssemblyTitleAttribute("MailBoxProcessor.Tests")>]
[<assembly: AssemblyProductAttribute("MailBoxProcessor")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MailBoxProcessor.Tests"
    let [<Literal>] AssemblyProduct = "MailBoxProcessor"
