...
[<assembly: AssemblyTitleAttribute("ATMLibrary.Tests")>]
[<assembly: AssemblyProductAttribute("ATMLibrary")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "ATMLibrary.Tests"
    let [<Literal>] AssemblyProduct = "ATMLibrary"
